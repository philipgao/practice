...
public class Ch04GraphUtilTest {
	...
	@Test
	public void testP404IsPCBWiringLayoutPossible(){
		...
		assertTrue(Ch04GraphUtil.p404IsPCBWiringLayoutPossible(v1));

		Edge edge25 = new Edge(v2, v5);
		Edge edge34 = new Edge(v3, v4);

		assertFalse(Ch04GraphUtil.p404IsPCBWiringLayoutPossible(v1));
	}
	
	@Test
	public void testP413ComputeSortestPathNumber(){
